...
const formSchema = z.object({
  ...
  tax_pct: z.number({ invalid_type_error: "Must be a number" }).min(0).max(100),
  discount: z.number({ invalid_type_error: "Must be a number" }).min(0),
  upfront_payment: z.number({ invalid_type_error: "Must be a number" }).min(0),
